Jacqueline Chavez and Phoebe Evans 
CS 234 Group Project
Stage 3
...
Then open the command prompt. Next type “javac ApplicationStart.java” This step compiles the code. Now, type “java ApplicationStart”. This will run the program. 
