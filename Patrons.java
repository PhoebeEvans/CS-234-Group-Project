...
public class Patrons {
    ...
    public void addPatron() throws FileNotFoundException{
        ...
        //name
        name = stringC("Please type the name of the Patron: ");
        
        //dob
        
        dateofBirth = stringC("Please type dob: ");
        ...
        //address 
        address = stringC("Please type the address of the patron: ");
        
        //phone
        phone = stringC("Please type the phone number: ");
            ...
            if(response == in.nextInt()){
                ...
                while(loop2 == 1 ){
                    ...
                    if(pick2 == 2){
                        ...
                        arrLine[4] = stringC("Please type the Date of Birth: ");
                    ...
                    if(pick2 == 3){
                        ...
                        arrLine[5] = stringC("Please type the Address: ");
                    ...
                    if(pick2 == 4){
                        ...
                        arrLine[6] = stringC("Please type the phone number: ");
    ...
    public void viewPatrons() throws FileNotFoundException{
        ...
        Files replace = new Files("Patrons.txt");
        replace.viewFile();
    }
    ...
    public void searchPatrons() throws FileNotFoundException{
        ...
        while(cnum == 1){
            ...
            PrintWriter loans = new PrintWriter("loansP.txt");
            //name searcher
            //country searcher
                    ...
                    while(count < rnum){
                        ...
                        for(String dNew: spliter){
                            ...
                            if(resp1.equals(dNew)){
                                System.out.println(num + " _ " + nameArr[count] + " - " + ageArr[count] + " - " + ageGroupArr[count] + " - " + dobArr[count] + " - " + addressArr[count]+ " - " + phoneArr[count] + " - " + idArr[count]);
